...
public class JDBCOracleClientUtil {
    ...
    public static JDBCClient getOracleJDBCClient(Vertx vertx, OracleDBVO vo) {
        if (jdbcClient == null) {
...
//                            .put("password", "smartpark")
    ...
    public static void executeUpdateCommon(Vertx vertx, OracleDBVO vo, String sql, Handler<UpdateResult> resultSetHandler) {
    ...
    public static void executeCommon(Vertx vertx, OracleDBVO vo, String sql, JsonArray params, Handler<ResultSet> resultSetHandler) {
    ...
    public static void executeUpdateTX(Vertx vertx, OracleDBVO vo, Handler<TXHandlerVO> taskHandler, Handler<Boolean> resultHandler) {
        getOracleJDBCClient(vertx, vo).getConnection(conn -> {
            if (conn.failed()) {
                System.err.println(conn.cause().getMessage());
                return;
